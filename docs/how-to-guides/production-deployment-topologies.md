...
3. **Configure `feastProjectDir.packaged`** with the image and the absolute path to the bundled repository. Keep the path outside operator-mounted locations such as `/feast-data`.
